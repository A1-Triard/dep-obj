...
#[derive(Educe)]
#[educe(Default)]
pub struct Arena<P1: SizedDepType + 'static, P2: SizedDepType + 'static>(StateDrop<ArenaImpl<P1, P2>>);

impl<P1: SizedDepType + 'static, P2: SizedDepType + 'static> SelfState for Arena<P1, P2> { }

#[derive(Educe)]
#[educe(Default)]
struct ArenaImpl<P1, P2>(components_arena_Arena<Component<P1, P2>>);

impl<P1: SizedDepType + 'static, P2: SizedDepType + 'static> RequiresStateDrop for ArenaImpl<P1, P2> {
...
impl<P1: SizedDepType + 'static, P2: SizedDepType + 'static> Arena<P1, P2> {
    pub fn new() -> Self {
...
impl<P1: SizedDepType + 'static, P2: SizedDepType + 'static> Id<P1, P2> {
